            ...
            <div className="relative z-10 flex flex-col min-h-screen">
                ...
                <main className="flex-grow flex flex-col items-center justify-center p-6 py-12 lg:py-20">
                    <div className="w-full max-w-4xl flex flex-col items-center text-center">
                        ...
                        <h1 className="text-white text-5xl md:text-7xl lg:text-8xl font-light font-headline leading-tight tracking-tight mb-6">
                            Payment<br className="md:hidden" /> Successful
                        </h1>
                        <p className="text-white/60 text-lg md:text-xl font-body max-w-xl font-light leading-relaxed mb-16">
                        ...
                        <div className="flex flex-col items-center w-full gap-5">
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full">
                                <Button asChild variant="outline" className="group relative w-full sm:w-auto min-w-[200px] h-14 rounded-full bg-accent/20 backdrop-blur-xl border-accent/50 hover:bg-accent/30 transition-all duration-300 text-white text-base font-semibold tracking-wide font-body z-10">
                                    <Link href="/">Return to Home</Link>
                                </Button>
                                <Button variant="ghost" className="w-full sm:w-auto min-w-[200px] h-14 rounded-full text-white/70 hover:text-white hover:bg-white/5 transition-all text-base font-medium font-body gap-2 border border-transparent hover:border-white/10">
                                    <Download size={20} />
                                    <span>Download Receipt</span>
                                </Button>
                            </div>
                            <a className="flex w-full sm:w-auto min-w-[240px] sm:min-w-[400px] h-14 cursor-pointer items-center justify-center rounded-xl bg-white/5 hover:bg-[#25D366]/10 border border-[#25D366]/40 backdrop-blur-md transition-all text-white gap-3 px-8 text-sm font-bold tracking-wide group mt-4 font-body" href="https://wa.me/?text=I%20just%20sowed%20a%20seed%20at%20VOSEM%20INT'L!%20Join%20us%20in%20experiencing%20God's%20grace.%20https://vosem.org" target="_blank" rel="noopener noreferrer">
